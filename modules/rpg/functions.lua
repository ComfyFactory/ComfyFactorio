    ...
    if one_time_reset then
        ...
        rpg_t =
            ...
            player.index,
            {
                ...
                dropdown_select_index_4 = 1,
                dropdown_select_name_4 = Public.all_spells[1].name[1],
                dropdown_select_index_5 = 1,
                dropdown_select_name_5 = Public.all_spells[1].name[1],
                dropdown_select_index_6 = 1,
                dropdown_select_name_6 = Public.all_spells[1].name[1],
                allocate_index = 1,
