...
function get_loot_item_stack()
    ...
    for _, t in pairs(chest_loot) do
        for x = 1, t.weight, 1 do
            if t.evolution_min <= game.forces.enemy.get_evolution_factor(1) and t.evolution_max >= game.forces.enemy.get_evolution_factor(1) then
...
function spawn_market(surface, position)
    ...
    market.add_market_item({ price = { { name = 'coin', count = 10 } }, offer = { type = 'give-item', item = 'grenade', count = 1 } })
    ...
    market.add_market_item({ price = { { name = 'coin', count = 64 } }, offer = { type = 'give-item', item = 'car', count = 1 } })
end
