...
local SideTargets = require 'maps.amap.modules.wave_defense.side_targets'
local ThreatEvent = require 'maps.amap.modules.wave_defense.threat_events'
local update_gui = require 'maps.amap.modules.wave_defense.gui'
local threat_values = require 'maps.amap.modules.wave_defense.threat_values'
