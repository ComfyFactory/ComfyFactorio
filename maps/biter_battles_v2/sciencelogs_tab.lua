        ...
        for i = 1, #global.science_logs_date, 1 do
            ...
            if dropdown_force.selected_index == 1 or real_force_name:match(dropdown_force.get_item(dropdown_force.selected_index)) then
                if
                 ...
                 then
                    if
                        dropdown_evofilter.selected_index == 1 or (dropdown_evofilter.selected_index == 2 and (global.science_logs_evo_jump_difference[i] > 0)) or
                            (dropdown_evofilter.selected_index == 3 and (global.science_logs_evo_jump_difference[i] >= 10)) or
                            (dropdown_evofilter.selected_index == 4 and (global.science_logs_evo_jump_difference[i] >= 5)) or
                            (dropdown_evofilter.selected_index == 5 and (global.science_logs_evo_jump_difference[i] >= 4)) or
                            (dropdown_evofilter.selected_index == 6 and (global.science_logs_evo_jump_difference[i] >= 3)) or
                            (dropdown_evofilter.selected_index == 7 and (global.science_logs_evo_jump_difference[i] >= 2)) or
                     ...
                     then
                        ...
                        local label =
                            ...
                            caption = global.science_logs_evo_jump[i] .. '   [color=200,200,200](+' .. global.science_logs_evo_jump_difference[i] .. ')[/color]'
                        }
                        ...
                        local label =
                            ...
                            caption = global.science_logs_threat[i] .. '   [color=200,200,200](+' .. global.science_logs_threat_jump_difference[i] .. ')[/color]'
                        }
