...
local function create_explosion_schedule(entity)
    ...
    local explosives_amount = math_floor(fluid.amount)
    ...
    this.fluid_explosion_schedule[#this.fluid_explosion_schedule].damage_remaining = fluid_damages[fluid.name] * explosives_amount
