...
local all_research = {
   ...
   { name = "battery-equipment",                min = 2,  max = 5 },
   { name = "modules",                          min = 2,  max = 5 },
   { name = "speed-module",                     min = 2,  max = 5 },
   { name = "productivity-module",              min = 2,  max = 5 },
   { name = "efficiency-module",                min = 2,  max = 5 },
   { name = "advanced-material-processing",     min = 3,  max = 5 },
   { name = "circuit-network",                  min = 1,  max = 5 },
   { name = "explosives",                       min = 2,  max = 5 },
   { name = "toolbelt",                         min = 1,  max = 5 },
   { name = "engine",                           min = 1,  max = 5 },
   { name = "oil-gathering",                    min = 2,  max = 5 },
   { name = "oil-processing",                   min = 2,  max = 5 },
   { name = "stronger-explosives-1",            min = 2,  max = 5 },
   { name = "modular-armor",                    min = 3,  max = 5 },
   { name = "solar-panel-equipment",            min = 3,  max = 5 },
   { name = "electric-energy-distribution-1",   min = 1,  max = 5 },
   { name = "battery",                          min = 2,  max = 5 },
   { name = "electric-energy-accumulators",     min = 2,  max = 5 },
   { name = "bulk-inserter",                    min = 2,  max = 5 },
   { name = "sulfur-processing",                min = 2,  max = 5 },
   { name = "advanced-circuit",                 min = 2,  max = 5 },
   { name = "logistics-2",                      min = 1,  max = 5 },
   { name = "plastics",                         min = 2,  max = 5 },
   { name = "physical-projectile-damage-2",     min = 2,  max = 5 },
   { name = "weapon-shooting-speed-2",          min = 2,  max = 5 },
   { name = "solar-energy",                     min = 1,  max = 5 },
   { name = "mining-productivity-1",            min = 2,  max = 5 },
   ...
   { name = "physical-projectile-damage-3",     min = 6,  max = 10 },
   { name = "weapon-shooting-speed-3",          min = 6,  max = 10 },
   { name = "refined-flammables-2",             min = 6,  max = 10 },
   { name = "follower-robot-count-2",           min = 5,  max = 10 },
   { name = "physical-projectile-damage-4",     min = 7,  max = 10 },
   { name = "weapon-shooting-speed-4",          min = 7,  max = 10 },
   ...
   { name = "uranium-mining",                   min = 8,  max = 13 },
   ...
   { name = "laser-weapons-damage-2",           min = 10, max = 14 },
   { name = "laser-weapons-damage-3",           min = 11, max = 14 },
   { name = "laser-weapons-damage-4",           min = 12, max = 14 },
   { name = "laser-shooting-speed-3",           min = 11, max = 14 },
   { name = "laser-shooting-speed-4",           min = 12, max = 14 },
   { name = "follower-robot-count-4",           min = 12, max = 14 },
   ...
   { name = "fission-reactor-equipment",         min = 14, max = 21 },
   { name = "destroyer",                        min = 14, max = 21 },
   { name = "refined-flammables-4",             min = 15, max = 21 },
   { name = "refined-flammables-5",             min = 16, max = 21 },
   { name = "refined-flammables-6",             min = 17, max = 21 },
   { name = "stronger-explosives-4",            min = 15, max = 21 },
   { name = "stronger-explosives-5",            min = 16, max = 21 },
   { name = "stronger-explosives-6",            min = 17, max = 21 },
   { name = "power-armor-mk2",                  min = 17, max = 21 },
   ...
   { name = "laser-shooting-speed-5",           min = 15, max = 21 },
   { name = "laser-shooting-speed-6",           min = 16, max = 21 },
   { name = "laser-shooting-speed-7",           min = 17, max = 21 },
   { name = "laser-weapons-damage-5",          min = 16, max = 21 },
   { name = "laser-weapons-damage-6",          min = 17, max = 21 },
   ...
   { name = "laser-weapons-damage-7",          min = 20, max = 25 },
   ...
   { name = "follower-robot-count-5",           min = 20, max = 25 },
...
function Variable.calculate_distribution()
   ...
   for i = 1, #all_research do
      ...
      --if not technologies[v.name] then error(v.name .. ' not available tech') end
