...
Public.island1 = {}
Public.island1.Data =
	require('maps.pirates.noise_pregen.perlinwavelength100boxsize1000octaves5gain0p8lacunity2lengthpower1rms0p05423')
...
Public.forest1 = {}
Public.forest1.Data = require(
	'maps.pirates.noise_pregen.simplexwavelength100boxsize1000octaves5gain0p65lacunity2lengthpower1p2rms0p06243'
)
