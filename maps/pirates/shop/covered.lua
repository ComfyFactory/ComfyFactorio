...
Public.offers_default = {
	...
	{price = {{'coin', 750}}, offer = {type = 'give-item', item = 'piercing-rounds-magazine', count = 18}},
	{price = {{'coin', 750}}, offer = {type = 'give-item', item = 'heavy-armor', count = 1}},
	{price = {{'coin', 250}}, offer = {type = 'give-item', item = 'gun-turret', count = 2}},
	{price = {{'coin', 200}}, offer = {type = 'give-item', item = 'defender-capsule', count = 3}},
	{price = {{'coin', 400}}, offer = {type = 'give-item', item = 'distractor-capsule', count = 3}},
	{price = {{'coin', 200}}, offer = {type = 'give-item', item = 'destroyer-capsule', count = 1}},
	...
	{price = {{'coin', 600}}, offer = {type = 'give-item', item = 'gate', count = 12}},
