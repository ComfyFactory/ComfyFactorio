...
Public.market_offer_form = {
	...
	[enum.MORE_POWER] = {price = {{'coin', 9000}, {'coal', 1000}}, offer = {type='nothing', effect_description='Upgrade the ship\'s passive power generators.'}},
	...
	[enum.ROCKETS_FOR_SALE] = {price = {{'coin', 17500}, {'coal', 1500}}, offer = {type='nothing', effect_description='Unlock the sale of rockets at covered markets.'}},
}
